...
<html>
<head>
<title>PLANE CLUB</title>
<link href="<?php echo base_url ('gudang/css/bootstrap.css'); ?>" rel='stylesheet' type='text/css' />
<!-- jQuery (Bootstrap's JavaScript plugins) -->
<script src="<?php echo base_url('gudang/js/jquery.min.js'); ?>"></script>
<!-- Custom Theme files -->
<link href="<?php echo base_url('gudang/css/style.css'); ?>" rel="stylesheet" type="text/css" media="all" />
<!-- Custom Theme files -->
...
<!--animated-css-->
<link href="<?php echo base_url('gudang/css/animate.css'); ?>" rel="stylesheet" type="text/css" media="all">
<script src="<?php echo base_url('gudang/js/wow.min.js'); ?>"></script>
...
<!--/animated-css-->
<!--script-->
<script type="text/javascript" src="<?php echo base_url('gudang/js/move-top.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url('gudang/js/easing.js'); ?>"></script>
<!--/script-->
...
<!---->
	<div class="banner-bg">
		<video autoplay="autoplay" muted="muted" poster="wall_icons/my.jpg" width="100%"  loop>
			<source src="<?php echo base_url('gudang/srix.mp4'); ?>" type="video/mp4" type="video/mp4">
		</video>
		<div class="banner">
		 <div class="header">	 
			 <div class="logo wow fadeInLeft" data-wow-delay="0.5s">
			 <a href="<?php echo base_url(); ?>"><h1 style="color:white;">PLANE CLUB</h1></a>
			 </div>	
			 <div class="top-menu">
		 ...
		 <div class="booking-form">
					<!---strat-date-piker---->
					<link rel="stylesheet" href="<?php echo base_url('gudang/css/jquery-ui.css')?>" />
					<script src="<?php echo base_url('gudang/js/jquery-ui.js') ?>"></script>
							  <script>
									  $(function() {
					...
					<!---/End-date-piker---->
					<link type="text/css" rel="stylesheet" href="<?php echo base_url('gudang/css/JFGrid.css') ?>" />
					<link type="text/css" rel="stylesheet" href="<?php echo base_url('gudang/css/JFFormStyle-1.css') ?>" />
					<script type="text/javascript" src="<?php echo base_url ('gudang/js/JFCore.js') ?>"></script>
					<script type="text/javascript" src="<?php echo base_url ('gudang/js/JFForms.js') ?>"></script>
...
<div id="brief" class="brief">
	 <div class="container">
		 <div class="col-md-6 brief-grids wow fadeInLeft" data-wow-delay="0.5s">
			 <img src="<?php echo base_url('gudang/images/browse.jpg') ?>" alt=""/>
		 ...
		 <div class="col-md-6 brief-grids wow fadeInRight" data-wow-delay="0.5s">
			 <img src="<?php echo base_url('gudang/images/browse2.jpg') ?>" alt=""/>
			 <div class="brief-grid">
				 <div class="brief-grid-text">
	 ...
	 <div class="container">
		...
		<div class="video-grids">
			...
			<div class="col-md-4 video-right">
				<img src="<?php echo base_url('gudang/images/1.jpg') ?>" alt="" />
				...
				<link href="<?php echo base_url('gudang/css/popuo-box.css') ?>" rel="stylesheet" type="text/css" media="all"/>
				<script src="<?php echo base_url('gudang/js/jquery.magnific-popup.js') ?>" type="text/javascript"></script>
				<script>
						$(document).ready(function() {
						$('.popup-with-zoom-anim').magnificPopup({
						type: 'inline',
...
<div id="screenshots" class="screenshots">
	 <div class="container">
		 ...
		 <!-- requried-jsfiles-for owl -->
				<link href="<?php echo base_url ('gudang/css/owl.carousel.css') ?>" rel="stylesheet">
							    <script src="<?php echo base_url('gudang/js/owl.carousel.js') ?>"></script>
							        <script>
							    $(document).ready(function() {
		  ...
		  <div id="owl-demo" class="owl-carousel">
			  <div class="item text-center guide-sliders">
				 <div class="col-md-4 image-grid">
					 <img src="<?php echo base_url('gudang/images/sc1.jpg') ?>">					 
				 </div>
				 <div class="col-md-4 image-grid">
					 <img src="<?php echo base_url('gudang/images/sc2.jpg') ?>">					 
				 </div>
				 <div class="col-md-4 image-grid">
					 <img src="<?php echo base_url('gudang/images/sc3.jpg') ?>">					 
				 </div>				   
			  </div>			  
			  <div class="item text-center guide-sliders">
				 <div class="col-md-4 image-grid">
					 <img src="<?php echo base_url('gudang/images/sc4.jpg') ?>">					 
				 </div>
				 <div class="col-md-4 image-grid">
					 <img src="<?php echo base_url('gudang/images/sc5.jpg') ?>">					 
				 </div>
				 <div class="col-md-4 image-grid">
					 <img src="<?php echo base_url('gudang/images/sc1.jpg') ?>">					 
				 </div>						
...
<div class="footer">
	 <div class="container">
		 <div class="ftr-logo">
			 <a class="wow bounceIn" data-wow-delay="0.5s" href="index.html"><img src="<?php echo base_url('gudang/images/logo2.png') ?>" alt=""/></a>
		 </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="<?php echo base_url('home/index.php/loginProcess'); ?>" method="post">
          ...
          <div class="modal-footer">
            <span class="text-left">
              <p class="text-left">Belum punya akun? <a href="<?php echo base_url('index.php/home/ndaftar') ?>">Daftar </a></p>
            </span>
          </div>
        </div>
      </div>
